...
public class UrlConstant {
    ...
    public static class Url{
        ...
        public static final String ALL_RIDES_URL = SERVER_URL + "sharerid/sar/web%20services/get_all_rides.php";
        public static final String ALL_COUNTRIES_URL = SERVER_URL + "sharerid/sar/web%20services/get_all_countries.php";
        public static final String ALL_APPS_URL = SERVER_URL + "sharerid/sar/web%20services/get_all_app.php";
        public static final String ALL_MESSAGES_URL = SERVER_URL + "sharerid/web%20services/get_my_all_messages.php";
