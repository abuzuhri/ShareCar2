...
public class ReviewRide extends ActionBarActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    Ride ride;
    User user;
...
//                Toast.makeText(ReviewRide.this,""+ride.getTo_latitude()+" , "+ride.getTo_longitude(),Toast.LENGTH_LONG).show();
        ...
        quick_msg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ReviewRide.this, "", Toast.LENGTH_SHORT).show();
