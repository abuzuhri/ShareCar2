...
import sharearide.com.orchidatech.jma.sharearide.Chat.SettingsActivity;
...
import sharearide.com.orchidatech.jma.sharearide.Fragment.Setting;
...
public class ShareRide extends ActionBarActivity {
    ...
    String TITLES[] = {"Offer a Ride","Find a Ride", "My Rides","Inbox","Search","Setting", "About", "Terms of Use","Logout"};
        ...
        mAdapter = new DrawerAdapter(this, TITLES,NAME,EMAIL,profileImage, new DrawerAdapter.OnRecycleViewItemClicked() {
            ...
            public void onItemClicked(int position) {
                ...
                switch (position) {
                    ...
                    case 6:
                        Drawer.closeDrawers();
                       startActivity(new Intent(ShareRide.this, SettingsActivity.class));
                        break;
                    case 7:
                        Drawer.closeDrawers();
                        getFragmentManager()
                    ...
                    case 9:
                        ...
                        if(getApplicationContext().getSharedPreferences("pref", MODE_PRIVATE).getInt("network", -1) == 2){
                            ...
                            getApplicationContext().getSharedPreferences("pref", MODE_PRIVATE).edit().remove("network");
            ...
            @Override
            public void onClicked(ImageView image) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
         ...
         * */
            ...
            MainUserFunctions.uploadImage(getApplicationContext(), getSharedPreferences("pref", MODE_PRIVATE).getLong("id", -1), image_str);
