...
public class AddEditRide extends Fragment implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener{
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       setHasOptionsMenu(true);
        ...
        origin_ride = ride;
Toast.makeText(getActivity(), getArguments().getLong("id", -1)+"", Toast.LENGTH_LONG).show();
...
//                    }
                ...
                if (cityFrom.getText().toString().equals("")) {
                    ...
                    MainUserFunctions.update_ride(getActivity(), ride.getRemoteId(), cityFrom.getText().toString(), cityTo.getText().toString(), stateFrom.getText().toString(), stateTo.getText().toString(), countryFrom.getText().toString(), countryTo.getText().toString(), date_time_converter(), price.getText().toString(), from_Lattitude, from_Longitude, to_Lattitude, to_Longitude, info.getText().toString(), new OnUpdateRideListener() {
                        @Override
        ...
        more_info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                confirm_btn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ride.info = info.getText().toString();
